...
class TextController extends Controller
{
    ...
    {
        return view('laracms.content::text.index', [
    ...
    {
        return view('laracms.content::text.form');
    }
    ...
    public function store(ContentRequest $request)
    {
        ...
        return redirect()->route('laracms.content.text')->with('status', 'Content created!');
    }
    ...
    {
        return view('laracms.content::text.form', compact('content'));
    }
    ...
    {
        $content->delete();
        return redirect()->route('laracms.content.text')->with('status', 'Content deleted! Make sure to remove it from blade');
    }
}